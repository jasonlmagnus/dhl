...
const accounts = [
  {
    ...
    region: "UK",
    status: "Active",
    description: "Leading soft drinks manufacturer seeking supply chain transformation",
  },
  {
    id: "britvic",
    name: "Britvic",
    logo: "/britvic-logo.jpg",
    opportunity: "£65m",
    sector: "Beverages",
    region: "UK & Ireland",
    status: "Active",
    description: "International beverage company requiring multi-site logistics",
  },
  {
    id: "hovis",
    name: "Hovis",
    ...
    region: "UK",
    status: "Active",
    description: "Heritage bakery brand modernizing distribution network",
  },
  {
    id: "warburtons",
    name: "Warburtons",
    logo: "/warburtons-logo.jpg",
    opportunity: "£78m",
    sector: "Food Manufacturing",
    region: "UK",
    status: "Active",
    description: "Family bakery business scaling operations nationwide",
  },
  {
    id: "muller",
    name: "Müller",
    logo: "/muller-dairy-logo.jpg",
    opportunity: "£95m",
    sector: "Dairy",
    region: "UK & Europe",
    status: "Active",
    description: "Dairy giant optimizing cold chain logistics",
  },
]
        ...
        <div className="container relative mx-auto px-6 py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-black/80 leading-relaxed">
              Your gateway to DHL's top strategic growth partnerships. Access comprehensive intelligence, value
              propositions, and AI-powered insights for five priority accounts.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="bg-card border-2 border-[hsl(355,85%,45%)] rounded-lg p-6 shadow-lg">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-bold text-[hsl(355,85%,45%)]">£330m</div>
            ...
            <div className="bg-gradient-to-br from-[hsl(45,100%,50%)] to-[hsl(355,85%,45%)] rounded-lg p-6 shadow-lg">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-white/90 flex items-center justify-center">
                  <Sparkles className="h-6 w-6 text-[hsl(355,85%,45%)]" />
                </div>
                <div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-[hsl(45,100%,50%)]/10 rounded-lg border border-[hsl(45,100%,50%)]/30">
                        ...
                        <span className="font-bold text-lg text-[hsl(355,85%,45%)]">{account.opportunity}</span>
                      </div>
